...
const SERVICES = [
  {
    ...
    title: "Family Law",
    description:
      "Compassionate guidance on divorce, child custody, maintenance and family disputes — handled with discretion and care.",
  ...
  },
  {
    ...
    description:
      "Clear advice on workplace disputes, contracts, dismissal and settlement — protecting your rights at work.",
    image: "/images/services/employment.png",
  },
  {
    id: "03",
    title: "Property & Conveyancing",
    description:
      "End-to-end support for first-home buyers, sales, purchases and transfers — straightforward, fixed-fee conveyancing.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 pt-4">
            <div className="space-y-1 mb-12">
              <h2 className="font-display font-extrabold tracking-tight leading-[1.05] whitespace-nowrap text-3xl md:text-4xl lg:text-5xl text-secondary">
                How I can help you
              </h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 flex-1">
                      <span
                        className={cn(
                          "font-display font-bold text-2xl md:text-3xl lg:text-4xl tracking-tight leading-[1.05] transition-colors duration-500",
              ...
              <div className="relative aspect-[4/5] md:aspect-[4/3] lg:aspect-[16/11] rounded-3xl md:rounded-[2.5rem] overflow-hidden bg-muted/30 border border-border/40">
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-secondary/25 via-transparent to-transparent opacity-60" />
                  </motion.div>
                </AnimatePresence>
